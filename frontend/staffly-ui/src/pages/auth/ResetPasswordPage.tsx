...
export default function ResetPasswordPage() {
    ...
    const handleResetPassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccess(true);
            setMessage("Şifreniz başarıyla sıfırlandı. Sisteme tekrar giriş yapılıyor.");
        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-black">
            {errorModalOpen && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
                    <div className="w-full max-w-md rounded-3xl border border-rose-500/30 bg-slate-950 p-6 shadow-[0_0_70px_rgba(15,23,42,0.95)]">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-white">Şifre Hatası</h3>
            ...
            <div className="absolute inset-0">
                <img
                    src={loginBg}
                    alt="Staffly Reset Password Background"
            ...
            <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-10">
                ...
                <div className="w-full max-w-[31rem] rounded-[2rem] border border-white/15 bg-slate-950/48 p-8 shadow-[0_0_75px_rgba(15,23,42,0.9)] backdrop-blur-2xl">
                    <div className="mb-7 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm leading-6 text-slate-400">
                                {hasToken
                                    ? "Hesabınız için yeni bir şifre belirleyin ve güvenli şekilde devam edin."
                                    : "E-posta adresinizi girin. Şifre sıfırlama bağlantısı mail adresinize gönderilecektir."}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-7 flex items-center justify-between border-t border-white/10 pt-5 text-xs text-slate-400">
                        ...
                        <span>Bağlantınız SSL ile korunur</span>
                    </div>
                </div>
            </div>
        </div>
